...
#ifndef CTRIDHWZEDBALUB_H
#define CTRIDHWZEDBALUB_H

#include "Idhw.h"

#define CmdIdhwZedbAlubValget CtrIdhwZedbAlub::CmdValget

#define VecVIdhwZedbAlubCommand CtrIdhwZedbAlub::VecVCommand
#define VecVIdhwZedbAlubError CtrIdhwZedbAlub::VecVError
#define VecVIdhwZedbAlubReg CtrIdhwZedbAlub::VecVReg

/**
	* CtrIdhwZedbAlub
	*/
class CtrIdhwZedbAlub : public CtrIdhw {

public:
	/**
		* CmdValget (full: CmdIdhwZedbAlubValget)
		*/
	...
	/**
		* VecVCommand (full: VecVIdhwZedbAlubCommand)
		*/
	class VecVCommand {
	...
	/**
		* VecVError (full: VecVIdhwZedbAlubError)
		*/
	class VecVError {
	...
	/**
		* VecVReg (full: VecVIdhwZedbAlubReg)
		*/
	class VecVReg {
...
public:
	CtrIdhwZedbAlub(XchgIdhw* xchg, const uint ixVTarget, const ubigint uref);
