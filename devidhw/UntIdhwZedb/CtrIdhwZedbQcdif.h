...
#ifndef CTRIDHWZEDBQCDIF_H
#define CTRIDHWZEDBQCDIF_H

#include "Idhw.h"

#include "UntIdhwIcm2_vecs.h"

#define VecVIdhwZedbQcdifCommand CtrIdhwZedbQcdif::VecVCommand
#define VecVIdhwZedbQcdifError CtrIdhwZedbQcdif::VecVError

/**
	* CtrIdhwZedbQcdif
	*/
class CtrIdhwZedbQcdif : public CtrIdhw {

public:
	/**
		* VecVCommand (full: VecVIdhwZedbQcdifCommand)
		*/
	class VecVCommand {
	...
	/**
		* VecVError (full: VecVIdhwZedbQcdifError)
		*/
	class VecVError {
...
public:
	CtrIdhwZedbQcdif(XchgIdhw* xchg, const uint ixVTarget, const ubigint uref);
