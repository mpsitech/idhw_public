...
/******************************************************************************
 class CtrIdhwZedbAlub::CmdValget
 ******************************************************************************/

CtrIdhwZedbAlub::CmdValget::CmdValget() : Cmd(0x04, VecVCommand::VALGET, Cmd::VecVRettype::IMMSNG) {
	returnSpeccallback = NULL;
	argReturnSpeccallback = NULL;
};

void CtrIdhwZedbAlub::CmdValget::setReturnSpeccallback(
...
void CtrIdhwZedbAlub::CmdValget::returnToCallback() {
...
/******************************************************************************
 class CtrIdhwZedbAlub::VecVCommand
 ******************************************************************************/

utinyint CtrIdhwZedbAlub::VecVCommand::getTix(
			const string& sref
		) {
...
string CtrIdhwZedbAlub::VecVCommand::getSref(
			const utinyint tix
		) {
...
void CtrIdhwZedbAlub::VecVCommand::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class CtrIdhwZedbAlub::VecVError
 ******************************************************************************/

utinyint CtrIdhwZedbAlub::VecVError::getTix(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CtrIdhwZedbAlub::VecVError::getSref(
			const utinyint tix
		) {
...
string CtrIdhwZedbAlub::VecVError::getTitle(
			const utinyint tix
		) {
...
/******************************************************************************
 class CtrIdhwZedbAlub::VecVReg
 ******************************************************************************/

utinyint CtrIdhwZedbAlub::VecVReg::getTix(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CtrIdhwZedbAlub::VecVReg::getSref(
			const utinyint tix
		) {
...
string CtrIdhwZedbAlub::VecVReg::getTitle(
			const utinyint tix
		) {
...
void CtrIdhwZedbAlub::VecVReg::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class CtrIdhwZedbAlub
 ******************************************************************************/

CtrIdhwZedbAlub::CtrIdhwZedbAlub(
			XchgIdhw* xchg
...
utinyint CtrIdhwZedbAlub::getTixVCommandBySref(
			const string& sref
		) {
	return VecVCommand::getTix(sref);
};

string CtrIdhwZedbAlub::getSrefByTixVCommand(
			const utinyint tixVCommand
		) {
	return VecVCommand::getSref(tixVCommand);
};

void CtrIdhwZedbAlub::fillFeedFCommand(
			Feed& feed
		) {
	VecVCommand::fillFeed(feed);
};

Cmd* CtrIdhwZedbAlub::getNewCmd(
			const utinyint tixVCommand
		) {
	Cmd* cmd = NULL;
...
Cmd* CtrIdhwZedbAlub::getNewCmdAdd(
	...
	cmd->addParInv("aTixVReg", Par::VecVType::TIX, CtrIdhwZedbAlub::VecVReg::getTix, CtrIdhwZedbAlub::VecVReg::getSref, CtrIdhwZedbAlub::VecVReg::fillFeed);
	cmd->addParInv("bTixVReg", Par::VecVType::TIX, CtrIdhwZedbAlub::VecVReg::getTix, CtrIdhwZedbAlub::VecVReg::getSref, CtrIdhwZedbAlub::VecVReg::fillFeed);
	cmd->addParInv("cTixVReg", Par::VecVType::TIX, CtrIdhwZedbAlub::VecVReg::getTix, CtrIdhwZedbAlub::VecVReg::getSref, CtrIdhwZedbAlub::VecVReg::fillFeed);
...
Cmd* CtrIdhwZedbAlub::getNewCmdSub(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwZedbAlub::getNewCmdMult(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwZedbAlub::getNewCmdDiv(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwZedbAlub::getNewCmdPow(
			const utinyint aTixVReg
			, const utinyint exp
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwZedbAlub::getNewCmdLgcand(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwZedbAlub::getNewCmdLgcor(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwZedbAlub::getNewCmdLgcxor(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwZedbAlub::getNewCmdLgcnot(
			const utinyint aTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwZedbAlub::getNewCmdValset(
	...
	cmd->addParInv("r1TixVReg", Par::VecVType::TIX, CtrIdhwZedbAlub::VecVReg::getTix, CtrIdhwZedbAlub::VecVReg::getSref, CtrIdhwZedbAlub::VecVReg::fillFeed);
	cmd->addParInv("r1Val", Par::VecVType::VBLOB, NULL, NULL, NULL, 8);
	cmd->addParInv("r2TixVReg", Par::VecVType::TIX, CtrIdhwZedbAlub::VecVReg::getTix, CtrIdhwZedbAlub::VecVReg::getSref, CtrIdhwZedbAlub::VecVReg::fillFeed);
	cmd->addParInv("r2Val", Par::VecVType::VBLOB, NULL, NULL, NULL, 8);
	cmd->addParInv("r3TixVReg", Par::VecVType::TIX, CtrIdhwZedbAlub::VecVReg::getTix, CtrIdhwZedbAlub::VecVReg::getSref, CtrIdhwZedbAlub::VecVReg::fillFeed);
	cmd->addParInv("r3Val", Par::VecVType::VBLOB, NULL, NULL, NULL, 8);
	cmd->addParInv("r4TixVReg", Par::VecVType::TIX, CtrIdhwZedbAlub::VecVReg::getTix, CtrIdhwZedbAlub::VecVReg::getSref, CtrIdhwZedbAlub::VecVReg::fillFeed);
...
CtrIdhwZedbAlub::CmdValget* CtrIdhwZedbAlub::getNewCmdValget(
			const utinyint r1TixVReg
			, const utinyint r2TixVReg
			, const utinyint r3TixVReg
			, const utinyint r4TixVReg
...
string CtrIdhwZedbAlub::getSrefByTixVError(
			const utinyint tixVError
		) {
	return VecVError::getSref(tixVError);
};

string CtrIdhwZedbAlub::getTitleByTixVError(
			const utinyint tixVError
		) {
	return VecVError::getTitle(tixVError);
};

Err CtrIdhwZedbAlub::getNewErr(
			const utinyint tixVError
		) {
	Err err;
...
Err CtrIdhwZedbAlub::getNewErrInvalid() {
...
Err CtrIdhwZedbAlub::getNewErrMismatch() {
	Err err(VecDbeVAction::ERR, VecVError::MISMATCH);

	return err;
};

Err CtrIdhwZedbAlub::getNewErrSize() {
