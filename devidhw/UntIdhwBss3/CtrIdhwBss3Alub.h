/**
  * \file CtrIdhwBss3Alub.h
  * alub controller (declarations)
  * \author Alexander Wirthmueller
  * \date created: 22 Sep 2017
  * \date modified: 22 Sep 2017
  */

#ifndef CTRIDHWBSS3ALUB_H
#define CTRIDHWBSS3ALUB_H

#include "Idhw.h"

#define CmdIdhwBss3AlubValget CtrIdhwBss3Alub::CmdValget

#define VecVIdhwBss3AlubCommand CtrIdhwBss3Alub::VecVCommand
#define VecVIdhwBss3AlubError CtrIdhwBss3Alub::VecVError
#define VecVIdhwBss3AlubReg CtrIdhwBss3Alub::VecVReg

/**
	* CtrIdhwBss3Alub
	*/
class CtrIdhwBss3Alub : public CtrIdhw {

public:
	/**
		* CmdValget (full: CmdIdhwBss3AlubValget)
		*/
	...
	/**
		* VecVCommand (full: VecVIdhwBss3AlubCommand)
		*/
	class VecVCommand {
	...
	/**
		* VecVError (full: VecVIdhwBss3AlubError)
		*/
	class VecVError {
	...
	/**
		* VecVReg (full: VecVIdhwBss3AlubReg)
		*/
	class VecVReg {
...
public:
	CtrIdhwBss3Alub(XchgIdhw* xchg, const uint ixVTarget, const ubigint uref);
