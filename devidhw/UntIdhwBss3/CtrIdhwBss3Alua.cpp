...
/******************************************************************************
 class CtrIdhwBss3Alua::CmdValget
 ******************************************************************************/

CtrIdhwBss3Alua::CmdValget::CmdValget() : Cmd(0x03, VecVCommand::VALGET, Cmd::VecVRettype::IMMSNG) {
	returnSpeccallback = NULL;
	argReturnSpeccallback = NULL;
};

void CtrIdhwBss3Alua::CmdValget::setReturnSpeccallback(
...
void CtrIdhwBss3Alua::CmdValget::returnToCallback() {
...
/******************************************************************************
 class CtrIdhwBss3Alua::VecVCommand
 ******************************************************************************/

utinyint CtrIdhwBss3Alua::VecVCommand::getTix(
			const string& sref
		) {
...
string CtrIdhwBss3Alua::VecVCommand::getSref(
			const utinyint tix
		) {
...
void CtrIdhwBss3Alua::VecVCommand::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class CtrIdhwBss3Alua::VecVError
 ******************************************************************************/

utinyint CtrIdhwBss3Alua::VecVError::getTix(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CtrIdhwBss3Alua::VecVError::getSref(
			const utinyint tix
		) {
...
string CtrIdhwBss3Alua::VecVError::getTitle(
			const utinyint tix
		) {
...
/******************************************************************************
 class CtrIdhwBss3Alua::VecVReg
 ******************************************************************************/

utinyint CtrIdhwBss3Alua::VecVReg::getTix(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CtrIdhwBss3Alua::VecVReg::getSref(
			const utinyint tix
		) {
...
string CtrIdhwBss3Alua::VecVReg::getTitle(
			const utinyint tix
		) {
...
void CtrIdhwBss3Alua::VecVReg::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class CtrIdhwBss3Alua
 ******************************************************************************/

CtrIdhwBss3Alua::CtrIdhwBss3Alua(
			XchgIdhw* xchg
...
utinyint CtrIdhwBss3Alua::getTixVCommandBySref(
			const string& sref
		) {
	return VecVCommand::getTix(sref);
};

string CtrIdhwBss3Alua::getSrefByTixVCommand(
			const utinyint tixVCommand
		) {
	return VecVCommand::getSref(tixVCommand);
};

void CtrIdhwBss3Alua::fillFeedFCommand(
			Feed& feed
		) {
	VecVCommand::fillFeed(feed);
};

Cmd* CtrIdhwBss3Alua::getNewCmd(
			const utinyint tixVCommand
		) {
	Cmd* cmd = NULL;
...
Cmd* CtrIdhwBss3Alua::getNewCmdAdd(
	...
	cmd->addParInv("aTixVReg", Par::VecVType::TIX, CtrIdhwBss3Alua::VecVReg::getTix, CtrIdhwBss3Alua::VecVReg::getSref, CtrIdhwBss3Alua::VecVReg::fillFeed);
	cmd->addParInv("bTixVReg", Par::VecVType::TIX, CtrIdhwBss3Alua::VecVReg::getTix, CtrIdhwBss3Alua::VecVReg::getSref, CtrIdhwBss3Alua::VecVReg::fillFeed);
	cmd->addParInv("cTixVReg", Par::VecVType::TIX, CtrIdhwBss3Alua::VecVReg::getTix, CtrIdhwBss3Alua::VecVReg::getSref, CtrIdhwBss3Alua::VecVReg::fillFeed);
...
Cmd* CtrIdhwBss3Alua::getNewCmdSub(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwBss3Alua::getNewCmdMult(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwBss3Alua::getNewCmdDiv(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwBss3Alua::getNewCmdPow(
			const utinyint aTixVReg
			, const utinyint exp
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwBss3Alua::getNewCmdLgcand(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwBss3Alua::getNewCmdLgcor(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwBss3Alua::getNewCmdLgcxor(
			const utinyint aTixVReg
			, const utinyint bTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwBss3Alua::getNewCmdLgcnot(
			const utinyint aTixVReg
			, const utinyint cTixVReg
		) {
...
Cmd* CtrIdhwBss3Alua::getNewCmdValset(
	...
	cmd->addParInv("r1TixVReg", Par::VecVType::TIX, CtrIdhwBss3Alua::VecVReg::getTix, CtrIdhwBss3Alua::VecVReg::getSref, CtrIdhwBss3Alua::VecVReg::fillFeed);
	cmd->addParInv("r1Val", Par::VecVType::VBLOB, NULL, NULL, NULL, 8);
	cmd->addParInv("r2TixVReg", Par::VecVType::TIX, CtrIdhwBss3Alua::VecVReg::getTix, CtrIdhwBss3Alua::VecVReg::getSref, CtrIdhwBss3Alua::VecVReg::fillFeed);
	cmd->addParInv("r2Val", Par::VecVType::VBLOB, NULL, NULL, NULL, 8);
	cmd->addParInv("r3TixVReg", Par::VecVType::TIX, CtrIdhwBss3Alua::VecVReg::getTix, CtrIdhwBss3Alua::VecVReg::getSref, CtrIdhwBss3Alua::VecVReg::fillFeed);
	cmd->addParInv("r3Val", Par::VecVType::VBLOB, NULL, NULL, NULL, 8);
	cmd->addParInv("r4TixVReg", Par::VecVType::TIX, CtrIdhwBss3Alua::VecVReg::getTix, CtrIdhwBss3Alua::VecVReg::getSref, CtrIdhwBss3Alua::VecVReg::fillFeed);
...
CtrIdhwBss3Alua::CmdValget* CtrIdhwBss3Alua::getNewCmdValget(
			const utinyint r1TixVReg
			, const utinyint r2TixVReg
			, const utinyint r3TixVReg
			, const utinyint r4TixVReg
...
string CtrIdhwBss3Alua::getSrefByTixVError(
			const utinyint tixVError
		) {
	return VecVError::getSref(tixVError);
};

string CtrIdhwBss3Alua::getTitleByTixVError(
			const utinyint tixVError
		) {
	return VecVError::getTitle(tixVError);
};

Err CtrIdhwBss3Alua::getNewErr(
			const utinyint tixVError
		) {
	Err err;
...
Err CtrIdhwBss3Alua::getNewErrInvalid() {
...
Err CtrIdhwBss3Alua::getNewErrMismatch() {
	Err err(VecDbeVAction::ERR, VecVError::MISMATCH);

	return err;
};

Err CtrIdhwBss3Alua::getNewErrSize() {
