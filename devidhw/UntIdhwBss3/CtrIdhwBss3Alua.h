...
#ifndef CTRIDHWBSS3ALUA_H
#define CTRIDHWBSS3ALUA_H

#include "Idhw.h"

#define CmdIdhwBss3AluaValget CtrIdhwBss3Alua::CmdValget

#define VecVIdhwBss3AluaCommand CtrIdhwBss3Alua::VecVCommand
#define VecVIdhwBss3AluaError CtrIdhwBss3Alua::VecVError
#define VecVIdhwBss3AluaReg CtrIdhwBss3Alua::VecVReg

/**
	* CtrIdhwBss3Alua
	*/
class CtrIdhwBss3Alua : public CtrIdhw {

public:
	/**
		* CmdValget (full: CmdIdhwBss3AluaValget)
		*/
	...
	/**
		* VecVCommand (full: VecVIdhwBss3AluaCommand)
		*/
	class VecVCommand {
	...
	/**
		* VecVError (full: VecVIdhwBss3AluaError)
		*/
	class VecVError {
	...
	/**
		* VecVReg (full: VecVIdhwBss3AluaReg)
		*/
	class VecVReg {
...
public:
	CtrIdhwBss3Alua(XchgIdhw* xchg, const uint ixVTarget, const ubigint uref);
