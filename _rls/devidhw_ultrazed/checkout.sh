# file checkout.sh
# checkout script for Idhw device access library sources, release devidhw_ultrazed
# author Alexander Wirthmueller
# date created: 22 Sep 2017
# modified: 22 Sep 2017

export set SRCROOT=/home/mpsitech/emb/ultrazed/avnet-digilent-ultrazed-2017.2/build/tmp/sysroots/plnx_arm/root/src
